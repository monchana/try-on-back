"""
Django settings for cafe24 project.
...
SECRET_KEY = 'django-insecure-od&b%$+v&*8l+wnuyfa=((*bb9ngz$6paaf-u!s*w4e6fs47-y'
...
WSGI_APPLICATION = 'cafe24.wsgi.application'
...
TRYON_DIR = os.path.expanduser('~/data')
